...
export function tenantRenewalEmail(tenant: Tenant, days: number): string {
  return `
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;border:1px solid #ddd;border-radius:8px;overflow:hidden">
...
export function landlordContractEmail(tenant: Tenant, days: number, annualRent: number, reraInfo: string): string {
  return `
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;border:1px solid #ddd;border-radius:8px;overflow:hidden">
...
export function serviceChargeEmail(unit: Unit): string {
  return `
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;border:1px solid #ddd;border-radius:8px;overflow:hidden">
