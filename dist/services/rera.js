...
exports.calculateRentIncrease = calculateRentIncrease;
exports.getRERAInfo = getRERAInfo;
...
function calculateRentIncrease(currentRent, marketRent) {
...
async function getRERAInfo(area, currentRent) {
...
function buildRERANote(area, currentRent, marketRent) {
    const lines = [
